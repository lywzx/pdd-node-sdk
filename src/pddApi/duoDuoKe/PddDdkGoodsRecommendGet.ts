export const PDD_DDK_GOODS_RECOMMEND_GET = 'PDD_DDK_GOODS_RECOMMEND_GET';
...
export default interface InterfaceDefaultInterface {
  [PDD_DDK_GOODS_RECOMMEND_GET]: {
    requestInterface: PddDdkGoodsRecommendGetRequestInterface;
    responseInterface: PddDdkGoodsRecommendGetResponseInterface;
  };
}
