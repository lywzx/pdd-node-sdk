export const PDD_DDK_OAUTH_TOP_GOODS_LIST_QUERY = 'PDD_DDK_OAUTH_TOP_GOODS_LIST_QUERY';
...
export default interface InterfaceDefaultInterface {
  [PDD_DDK_OAUTH_TOP_GOODS_LIST_QUERY]: {
    requestInterface: PddDdkOauthTopGoodsListQueryRequestInterface;
    responseInterface: PddDdkOauthTopGoodsListQueryResponseInterface;
  };
}
