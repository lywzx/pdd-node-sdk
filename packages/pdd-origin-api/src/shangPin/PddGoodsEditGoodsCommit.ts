...
export const PDD_GOODS_EDIT_GOODS_COMMIT_LIMITERS = [
  {
    limiterLevel: 3,
    timeRange: 10,
    times: 6000,
...
export interface PddGoodsEditGoodsCommitRequestInterface {
   ...
   * @type: PddGoodsEditGoodsCommitGoodsTradeAttrRequestInterface
   * @default:
   *
   **/
  goods_trade_attr?: PddGoodsEditGoodsCommitGoodsTradeAttrRequestInterface;

  /**
   * @description: 商品出行信息
   * @type: PddGoodsEditGoodsCommitGoodsTravelAttrRequestInterface
   * @default:
   *
   **/
 ...
 * @example
 **/
export interface PddGoodsEditGoodsCommitGoodsTradeAttrRequestInterface {
  /**
  ...
  /**
   * @description: 预订须知
   * @type: PddGoodsEditGoodsCommitGoodsTradeAttrBookingNotesRequestInterface
   * @default:
   *
   **/
  booking_notes?: PddGoodsEditGoodsCommitGoodsTradeAttrBookingNotesRequestInterface;
 ...
 * @example
 **/
export interface PddGoodsEditGoodsCommitGoodsTradeAttrBookingNotesRequestInterface {
  /**
 ...
 * @example
 **/
export interface PddGoodsEditGoodsCommitGoodsTravelAttrRequestInterface {
  /**
