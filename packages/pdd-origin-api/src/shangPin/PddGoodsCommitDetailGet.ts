...
export interface PddGoodsCommitDetailGetGoodsCommitDetailResponseResponseInterface {
   ...
   * @type: PddGoodsCommitDetailGetGoodsCommitDetailResponseGoodsTradeAttrResponseInterface
   * @default:
   *
   **/
  goods_trade_attr: PddGoodsCommitDetailGetGoodsCommitDetailResponseGoodsTradeAttrResponseInterface;

  /**
   * @description: 商品出行信息
   * @type: PddGoodsCommitDetailGetGoodsCommitDetailResponseGoodsTravelAttrResponseInterface
   * @default:
   *
   **/
  ...
  /**
   * @description: 日历商品库存方式（0：普通型，1：日历型）
   * @type: number
   * @default:
   **/
  sku_type: number;
 ...
 * @example
 **/
export interface PddGoodsCommitDetailGetGoodsCommitDetailResponseGoodsTradeAttrResponseInterface {
  /**
   * @description: 提前预定天数
   * @type: number
   * @default:
 ...
 * @example
 **/
export interface PddGoodsCommitDetailGetGoodsCommitDetailResponseGoodsTravelAttrResponseInterface {
  /**
   * @description: 是否需要出行人信息
   * @type: boolean
   * @default:
   **/
