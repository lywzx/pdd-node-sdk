...
export const PDD_DDK_MERCHANT_LIST_GET_LIMITERS = [
  {
    limiterLevel: 3,
    timeRange: 3600,
    times: 3000000,
...
export interface PddDdkMerchantListGetRequestInterface {
  ...
  /**
   * @description: 是否有店铺收藏券 （true 所有；false 必须有券）
   * @type: boolean
   * @default:
   **/
  has_clt_cpn?: boolean;
  ...
  /**
   * @description: 筛选范围
   * @type: PddDdkMerchantListGetRangeVoListRequestInterface[]
   * @default:
   *
   **/
  range_vo_list?: PddDdkMerchantListGetRangeVoListRequestInterface[];
}
 ...
 * @example
 **/
export interface PddDdkMerchantListGetRangeVoListRequestInterface {
  /**
   * @description: 范围起始值
   * @type: string
   * @default:
