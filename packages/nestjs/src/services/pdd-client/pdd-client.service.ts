...
export class PddClientService {
   ...
   * @param key
   */
  public get<T extends Record<string, unknown> = any>(): PddClientCollect<T>;
  public get<T extends Record<string, unknown> = any>(key: string): PddClient<T>;
  public get<T extends Record<string, unknown> = any>(key?: string): PddClient | PddClientCollect<T> {
