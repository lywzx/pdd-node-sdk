import {ApiDetailInterface} from "../../scripts/interface/api-detail.interface";
import {buildParamsToCodeArr} from "../../scripts/util/generate-code";
